# This is functional but could use some polishing. It is for my own use to swap Nuke file paths and is not out in production. It is meant to be run from command line and takes inputs of 
